...
constexpr BatteryParams batteryTable[] = {
  {
    ...
    .float_voltage_min        = 13.2f,       // Restart threshold: 13.2V for lead-acid
    ...
    .idle_exit_time_ms        = 600000UL,    // 10 minutes - SMART RESTART timer (unchanged)
...

  {
    ...
    // CRITICAL: Lithium chemistries must NEVER enter FLOAT mode
    .name                     = "LiFePO₄ 12V",
    .bulk_voltage_max         = 14.6f,
    .bulk_voltage_min         = 13.6f,
    .absorption_voltage       = 14.4f,
    .float_voltage_max        = 0.0f,       // Disabled: Lithium must never float
    .float_voltage_min        = 13.2f,       // SMART RESTART threshold: 13.2V (restart when below)
    .battery_voltage_min      = 9.88f,
    .input_voltage_min        = 5.0f,
    ...
    .float_current            = 0.0f,     // Disabled: Lithium must never float
    ...
    //    .idle_exit_time_ms        = 300000UL,    // 5 minutes - SMART RESTART timer: 5 minutes (300000 ms)
    //    .float_exit_time_ms       = 0UL          // Disabled: Lithium must never float

    .absorption_time_ms = 20000UL,   // 20 sec (SIMULATION)
    .min_mode_time_ms   = 3000UL,    // 3 sec
    .idle_entry_time_ms = 3000UL,    // 3 sec
    .idle_exit_time_ms  = 3000UL,    // 3 sec
    .float_exit_time_ms = 0UL        // MUST remain 0 (no float)
...

  {
    ...
    .float_voltage_max        = 0.0f,       // Disabled: Lithium must never float
    .float_voltage_min        = 12.0f,       // SMART RESTART threshold: 12.0V (restart when below)
    .battery_voltage_min      = 9.88f,
    .input_voltage_min        = 5.0f,
    ...
    .idle_exit_time_ms        = 120000UL,    // 2 minutes - SMART RESTART timer: 2 minutes (120000 ms)
    .float_exit_time_ms       = 0UL          // Disabled: Lithium must never float
  }
};
